...
public class WeaponControl3rdView : IControl
{
    ...
    public void update(Entity entity, float dt)
    {
        ...
        UnitSearchHostileSystem.initialize_query_cfilter(using_weapon.weapon_type, cteam, ref rcinput.Filter);
        ...
        {
            if (using_weapon.can_autofire(dt))
            {
            ...
            {
                if(using_weapon.has_ammo() == false)
                {
